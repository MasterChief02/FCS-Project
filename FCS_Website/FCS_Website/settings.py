"""
Django settings for FCS_Website project.
...
SECRET_KEY = 'django-insecure-^t2tk#!%ogano&*oc5&fti1p4)=^p6n&u(k!xgj(1ml)hxbwz0'
...
WSGI_APPLICATION = 'FCS_Website.wsgi.application'
